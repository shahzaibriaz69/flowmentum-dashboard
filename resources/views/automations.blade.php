<x-app-layout>
    <div class="mb-7">
        ...
        <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Workflows and automated triggers.</p>
    </div>
    <div class="bg-white dark:bg-cardBg border border-slate-200 dark:border-cardBorder rounded-xl p-6 min-h-[400px] flex items-center justify-center">
        <p class="text-slate-500 dark:text-slate-400">Automations engine workspace.</p>
    </div>
</x-app-layout>